      ...
      <div className="max-w-[960px] z-10 relative flex items-center justify-center mx-auto flex-col">
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 justify-center w-full">
          ...
          <div className="bg-white shadow-md text-center  rounded-md pt-10 pb-4  ">
            <img
              src={`${import.meta.env.BASE_URL}categories/cat-2.png`}
              alt="Restaurant"
          ...
          <div className="bg-white shadow-md text-center  rounded-md pt-10 pb-4 ">
            <img
              src={`${import.meta.env.BASE_URL}categories/boutique.png`}
              alt="Boulangerie"
              className="h-20 w-20 mx-auto"
            />
          ...
          <div className="bg-white shadow-md text-center rounded-md pt-10 pb-4 ">
            <img
              src={`${import.meta.env.BASE_URL}categories/cat-5.png`}
              alt="Magasins"
              className="h-20 w-20 mx-auto"
            />
          ...
          <div className="bg-white shadow-md text-center rounded-md pt-10 pb-4">
            <img
              src={`${import.meta.env.BASE_URL}categories/pizzeria.png`}
              alt="Pizzeria"
              className="h-20 w-20 mx-auto"
            />
          ...
          <div className="bg-white shadow-md text-center rounded-md pt-10 pb-4">
            <img
              src={`${import.meta.env.BASE_URL}categories/cat-3.png`}
              alt="Hôtels"
              className="h-20 w-20 mx-auto"
            />
